				...
				<article className="max-w-6xl px-6 py-24 mx-auto space-y-12 text-gray-50">
					...
					<div className="pt-12 border-t border-gray-700">
						...
						<div className="flex justify-center pt-4 space-x-4 align-center">
							<a rel="noopener noreferrer" href="#" aria-label="GitHub" className="p-2 rounded-md text-gray-100 hover:text-purple-400">
							...
							<a rel="noopener noreferrer" href="#" aria-label="Dribble" className="p-2 rounded-md text-gray-100 hover:text-purple-400">
							...
							<a rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md text-gray-100 hover:text-purple-400">
								<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
							...
							<a rel="noopener noreferrer" href="#" aria-label="Email" className="p-2 rounded-md text-gray-100 hover:text-purple-400">
								<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
