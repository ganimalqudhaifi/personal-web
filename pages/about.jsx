    ...
    <PrimaryLayout activeIndex={2}>
      ...
      <div>
        <p className="text-zinc-300/90">
          ...
          <br/><br/>
          Singkat cerita saya gagal pada tahap wawancara tersebut. Beberapa waktu saya memutuskan untuk mendaftar kuliah di salah satu universitas yang cukup terkenal. Mungkin ini terdengar sombong tapi saya memiliki keahlian dalam bidang matematika sejak kecil, sehingga saya memilih untuk mengambil jurusan akuntansi. Pada awal semester, semuanya berjalan dengan lancar, hingga pada akhirnya ketika memasuki semester baru, saya menghadapi masalah finansial dan tidak dapat melanjutkan perkuliahan tersebut.
          <br/><br/>
          ...
          <br/><br/>
          Sebagai seorang pemrogram, saya sangat menikmati untuk mempelajari hal-hal baru, menyelesaikan masalah, mencari solusi terbaik, dan berkeinginan untuk dapat berkolaborasi dengan pemrogram lainnya.
        </p>
      </div>
    </PrimaryLayout>
  )
